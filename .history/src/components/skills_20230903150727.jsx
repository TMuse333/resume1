...
const Skills = () => {
  ...
  const skills = [
    { name: 'Competent in multiple forms of front end development including react, next and angular', description:  'I have made a project in react, next and angular js so that I have a wide arsenal of '+
