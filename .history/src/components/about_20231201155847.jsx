  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.p>
          Hello, I'm Thomas Musial, a 20-year-old  with a strong foundation for success. A decade of competitive basketball, rigorous strength training, and two years of computer science at Dalhousie along with a relentless work ethic have prepared me to be an exceptional salesman ready to make you money.
        </motion.p>
      </motion.div>
    </motion.div>
  );
