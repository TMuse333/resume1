...
export const attributes = [
  {
    ...
    description:`My unwavering dedication to a lifelong regimen of rigorous physical training has not only endowed me with boundless energy but has also cultivated a very strong physical presence. I firmly believe that these attributes will serve as invaluable assets in the realm of sales, enhancing my ability to make a strong and enduring impression on clients and to be able to put in many hours into the job without diminishing to my success in the field.`,
    background:TMuse
  },
  {
