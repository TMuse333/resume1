...
const Skills = () => {
  ...
  const style = (index) =>( {
    width: '150px',
    height: selectedSkillIndex === 3  && isSkillDescriptionVisible[3]? '300px' : '200px',
      ...
      <div className="skills-container ">
        {services.map((skill, index) => (
          ...
          >
            ...
            style={{height:isSkillDescriptionVisible[index] && selectedSkillIndex === index? '300px' : '200px'}}
            >
              {skill.name}
              {{isSkillDescriptionVisible[index] && selectedSkillIndex === index? skill.description}}
              <p>
