...
const ExperienceCarousel = () => {
  ...
  const handleNext = () => {
    ...
    setShiftAmount(shiftAmount + 150); // Increase shift amount by a fixed value (e.g., 150)
  };

  const handlePrev = () => {
    const prevIndex = (activeIndex - 1 + experiences.length) % experiences.length;
    setActiveIndex(prevIndex);
    setShiftAmount(shiftAmount - 150); // Decrease shift amount by a fixed value (e.g., 150)
  };
