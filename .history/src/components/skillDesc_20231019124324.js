...
export const attributes = [
  ...
  },
  {
    ...
    description:`Throughout my experiences, I've cultivated a sense of stoicism and resilience that allows me to excel even in high pressure and difficult situations. This capacity for maintaining composure was notably developed during 10 years  involvement in competitive basketball. I have a natural inclination to concentrate on what I can influence while not letting external factors disrupt my performance. I am dedicated to consistently delivering my best efforts while embracing the inherent uncertainties that life may present, all the while prioritizing the present moment as the key to my success.`,
    background:stoic
  },
  {
    name:'Very well read',
