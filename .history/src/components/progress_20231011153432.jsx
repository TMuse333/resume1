...
useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      // Loop through image elements to find the one closest to the center
      let closestImageIndex = null;
      let closestDistance = Number.MAX_VALUE;
      const threshold = 50; // Adjust this value to set a lower threshold
      ...
      imageElements.forEach((image, index) => {
        ...
        if (distanceToCenter < closestDistance && distanceToCenter < threshold) {
