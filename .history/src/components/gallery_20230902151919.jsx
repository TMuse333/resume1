...
const ovalMotion = {
    x: Array.from({ length: numKeyframes2 }, (_, i) => {
      const initialX = Math.cos((i * 2 * Math.PI) / numKeyframes2) * xAxisRadius;
      const finalX = initialX - 200; // Adjust the value as needed
      return finalX;
    }),
