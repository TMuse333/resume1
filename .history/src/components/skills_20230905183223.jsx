...
const Skills = () => {
  ...
  const skillStyles = (index) => ({
    boxShadow: isHovered && index === selectedSkillIndex ? '0 0 100px rgba(10, 128, 0, 1)' : null,
    backgroundColor: isHovered && index === selectedSkillIndex ? 'rgba(144, 238, 144, 1)' : 'transparent',
  
    transform: isHovered && index === selectedSkillIndex ? 'scale(1.2)' : 'scale(1)',
    padding: '10px',
    borderRadius: '30px'
