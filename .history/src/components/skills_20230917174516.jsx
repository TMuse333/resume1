...
const Skills = () => {
  ...
  const style = (index) =>( {
    width: 'px',
    height: selectedSkillIndex === index  && isSkillDescriptionVisible[index]? 'max-content' : '200px',
    ...
    <section id="skills" className="skills-section">
      ...
      <div className="skills-container ">
        {services.map((skill, index) => (
         ...
         //   style={{height:isSkillDescriptionVisible[index] && selectedSkillIndex === index? 'max-content' : '200px'}}
            >
              {skill.name}
