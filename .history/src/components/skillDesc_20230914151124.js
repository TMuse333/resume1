...
export const experiences = [
  ...
  ,
  {
    ...
    description: "Our expert team uses Blender to create immersive web environments and dynamic visuals that bring your online presence to life. From product showcases to interactive storytelling and breathtaking graphics, we turn your vision into reality.",
    image:blender
  },
  {
    title: `"C++ graphics `,
