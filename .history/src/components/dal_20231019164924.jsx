...
const Dal = () =>{
    ...
    return (
        ...
        style={{height:'300px'}}
        />
        <p>For the past two years (2021 toI attended Dalhousie for two years doing computer science.
            This experience gave me a very strong background in understanding complex theories and how computers work,
            along with coding skills and I even made this website myself! It gave 
        </p>
        </div>
    )
}
