...
const Campaign = () =>{
  ...
  <ul >
    ...
    width:'400px'}}
        ...
        <h1>Prepared for Sales</h1>
        Working on this campaign and being on the political scene for the premier of Nov Scotiataught me many valuable lessons beyond the ones
        abov
