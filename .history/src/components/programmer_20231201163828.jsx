...
const Programming = () => {
 ...
 quantum card game</a>
      ...
      projects. I have also done data structures working
      with binary trees, linkedlists and arraylists. 
      </p>
      <p>I have done a substantial amount in C, learning how to create and navigate through 
        binary trees and heaps </p>
    </div>
  );
};
