...
'I can also design custom graphics for websites' },
    ...
    { name: 'Very structured and calculated approach to learning', description: 'I beleive in working hard AND working smart. Im always interested in finding the best way to achieve certain outcomes and make sure I am taking the best'}
  ];
