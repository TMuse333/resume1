...
export const experiences = [
  {
    ...
    description: 'I have made multiple landing pages with react js to help others grow their brand!',
    image: react
  },
  {
    title: 'Bringing websites to life with blender',
    description: 'Our expert team harnesses the power of Blender to craft immersive web environments and dynamic visuals that breathe life into your online presence. Whether it's product showcases, interactive storytelling, or breathtaking graphics, we turn your vision into reality.'
  }
]
