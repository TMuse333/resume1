...
const ovalMotion = {
    ...
    rotate: Array.from({ length: numKeyframes2 * 1.5 }, (_, i) => (i * 360) / (numKeyframes2 * 1.5)), // Rotate an additional half of a full rotation
    transition: { duration: 0.5, repeat: 1 }, // Adjust duration as needed
  };
