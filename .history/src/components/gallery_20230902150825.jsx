...
const ovalMotion = {
  x: Array.from({ length: numKeyframes2 }, (_, i) => Math.cos((i * 2 * Math.PI) / numKeyframes) * xAxisRadius),
  y: Array.from({ length: numKeyframes2 }, (_, i) => Math.sin((i * 2 * Math.PI) / numKeyframes) * yAxisRadius),
  transition: { duration: 4, repeat: Infinity }, // Adjust duration as needed
};
  ...
  startCircularMotion(circularMotion)
