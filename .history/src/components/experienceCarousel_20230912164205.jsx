...
const shiftAmount = (dimensions[0].left - dimensions[dimensions.length - 1].left - 50 * counter);

// Update the style.left property for each element
for (let i = 0; i < elements.length; i++) {
  const currentLeft = parseInt(elements[i].style.left);
  elements[i].style.left = currentLeft - shiftAmount + "px";
}
