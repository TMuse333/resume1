  ...
  return (
    <motion.div className="about-container">
      ...
      <motion.div
        ...
        variants={{
          hidden: { opacity: 0, x: -100, transition: { duration: 1.2 } }, // Increase the duration to slow down the transition
          visible: { opacity: 1, x: 0, transition: { duration: 1.5 } }, // Increase the duration to slow down the transition
        }}
      >
