...
import ss1goku from '../images/ss1-goku.png'
import kakashi1 from '../images/first-kakashi.jpg'
import itachi1 from '../images/first-itachi.png'
import susanoo from '../images/susanoo.jpg'
import abuFlex from '../images/aboubacar-5-fire.png'
import vegeta1 from '../images/first-vegeta.png'
import abu1 from '../images/abu3.jpg'
import broly from '../images/broly.jpg'



import dunk from '../images/important_dunk.jpg'
import art from '../images/vegeta_progress.jpg'
import muscle from '../images/muscular_thomas.png'
import goku from '../images/goku-vs-jiren.jpg'

import smallTom from '../images/progress-pics/biggerTMuse.jpg'
import biggerTom from '../images/progress-pics/biggerTMuse.jpg'


import TMuse from '../images/be-about-it.png'
import dunk2 from '../images/cockback.png'
import mic from '../images/karaoke.jpg'
import stoic from '../images/Stoic-02.png'
import seduction from '../images/seduction.jpg'
...
export const experiences = [
  ...
  export const services = [
    ...
    //   name: 'Very coachable',
    //   description:
    //   'Through out my basketball years I was very obidient to my coaches and did as I was told.'+
    //   'I will take whatever sales training you give me very seriously and do my best to implement it effectivley'
    // },
    // {
    //   name: 'Very tenacious',
    //   description: `Whatever task or subject I've taken on in my life, I have dedicated substantial periods of time to improve at it,` +
    //   'Whenever I put my mind to something I put all of my effort into it and made great improvements at it.'+
    //   " I am ready for sales to be the next thing I become great at."
    // },
    // {
    //   name: 'Competent with technology',
    //   description: 'I completed two years of computer science at Dalhousie university, giving me a solid foundation on how '+
    //   "to use technology. I even built this website myself!"
    // },
    // {
    //   name: 'Very well presented',
    //   description: 'I am aware that how you present yourself matters in a sales job '+
    //   "and I put substantial effort into my appearance by staying in great shape and putting together nice business orientated outfits on to be taken seriously"
    // },
    // {
    //   name: 'Thrives on diligence and hard work.',
    //   description: 'I am a man who is built to work, especially at my young age of 20 where I have large amounts of energy to expend.'+
    //   `I always put my best effort forward because I dislike being lazy and wasting all of my potential, as you only live once.` +
    //   'Where ever I go I put my best foot forward and do my best to gain the maximum benefit from anything I do'
    // },
...
export const attributes = [
  ...
  },
  {
    ...
    description:`In every endeavor I've undertaken, I've consistently demonstrated an unwavering commitment to excellence. Whether it's been my decade-long tenure as a competitive basketball player, my pursuit of bodybuilding and vertical jump training, my passion for the arts, or any other venture I've embraced, my approach remains the same. I'm dedicated to continuously seeking out the most effective methods for improvement, yielding remarkable progress while persisting until the task is accomplished. This same drive and dedication will undoubtedly propel me to excel in the world of sales, where I'm poised to become a top-performing asset at the dealership.`
    background:dunk2
  },
  {
  ...
  {
    name:'Very well read',
    description:`Over the past three years, I have had the opportunity to delve into a diverse range of literature encompassing topics such as personal development, habit formation, health and wellness, quantum physics, and psychology, among others. Among the notable books that have left a lasting impact on me, "The Art of Seduction" by Robert Greene stands out as a valuable resource. This book has provided me with a strong foundation in the art of influence, a skill that I consider paramount in the field of sales.`,
    background:seduction
  }
